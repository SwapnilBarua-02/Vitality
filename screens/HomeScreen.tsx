...
const DAY_LABELS = ['12a', '4a', '8a', '12p', '4p', '8p', 'Now'];
const MONTH_LABELS = ['W1', 'W2', 'W3', 'W4', 'Now', '', ''];
const YEAR_LABELS = ['Jan', 'Mar', 'May', 'Jul', 'Sep', 'Nov', 'Now'];
...
export default function HomeScreen() {
  ...
  const [selectedRange, setSelectedRange] = useState<RangeKey>('W');
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.baselineControl}>
            ...
            <View style={styles.controlBtns}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  Haptics.selectionAsync();
                  setBaseline((b) => Math.min(100, b + 5));
                }}
              >
                <Text style={styles.circleBtnText}>+</Text>
              </TouchableOpacity>
        ...
        <View style={styles.gridWrap}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              Haptics.selectionAsync();
              moneyCard.screen && navigation.navigate(moneyCard.screen);
            }}
          >
