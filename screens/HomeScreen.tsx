...
const HABITS = [
  { name: 'Being active',     color: '#FF375F', progress: 0.8, screen: 'Active' },
  { name: 'Being productive', color: '#BF5AF2', progress: 0.6, screen: 'Productive' },
  { name: 'Cleaning',         color: '#30D158', progress: 1.0, screen: 'Cleaning' },
  { name: 'Self care',        color: '#FF9F0A', progress: 0.4, screen: 'SelfCare' },
  { name: 'Sleep',            color: '#0A84FF', progress: 0.9, screen: 'Sleep' },
];
